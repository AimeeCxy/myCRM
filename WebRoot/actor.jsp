...
<body>
    ...
    <div class="tools">
    	...
    	<ul class="toolbar">
        <a href="actoradd.jsp"><li><span><img src="images/t01.png" /></span>添加</li></a>
        <a href="actordelete.jsp"><li><span><img src="images/t03.png" /></span>删除</li>
        </ul>
    ...
    <table class="tablelist">
    	...
    	<td>
    	<br/><%=map.get("actorname") %>
    	</td>
    	<td>
    	<br/><%=map.get("useful") %>
    	</td>
    	<td>
    	<a href="actormodify.jsp?id=<%=map.get("id")%>">修改/</a>
    	<a href="actordelete.jsp?id=<%=map.get("id")%>">/删除</a>
    	</td>
    	<%} %>
  		</tr>
        </tbody>
